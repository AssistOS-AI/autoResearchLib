...
9. The generated article HTML should include browser-side print or save-PDF controls, but repository documentation and article text must remain honest that browser-managed print headers or footers cannot be fully suppressed through standard web APIs.
