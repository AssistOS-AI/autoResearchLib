...
dependsOn:
  ...
  - ../../specs/DS010-question-selection.md
  - ../../specs/DS012-cue-provenance.md
  - ./bibliography.md
---
...
| --- | --- | --- |
| P1 | `DS002 Introduction`, `DS002 Core Content` | Introduce `O(x)`, `T`, `N(O(x))`, and `F` as auditable objects rather than abstract placeholders. |
| P2 | `DS002 Core Content`, `DS006 Core Content`, `DS012 Core Content` | Explain observational hypotheses, typed cues, cue provenance, and canonical CNL projection. |
...
| P6 | `DS002 Core Content`, `DS010 Core Content` | Define entropy, information gain, question partitions, and rescue tolerance. Cite Shannon for entropy and Settles for active query selection. |
